  ...
  ui = navbarPage(theme = shinytheme("slate"), "Country metrics",
      ...
      tabPanel("Introduction",
        fluidPage(id="introductionPage",
          ...
          p("The dataset used (as it was used) can be found in the",
            a("file tree of my Statistical Learning project", href="https://github.com/dreth/UC3MStatisticalLearning/tree/main/data"),
